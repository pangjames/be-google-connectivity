...
CREATE TABLE `tb_hotel_calendar_inventory` (
  ...
  `restriction_master` varchar(50) NOT NULL COMMENT 'Open or Close',
  `restriction_arrival` varchar(50) NOT NULL COMMENT 'Open or Close',
  `restriction_departure` varchar(50) NOT NULL COMMENT 'Open or Close',
